    ...
    <div className="relative w-full h-screen flex justify-center flex-col">
      <div className="w-[90%] md:w-[80%] mx-auto items-center grid grid-cols-1 xl:grid-cols-2 gap-10">
        ...
        <div data-aos="fade-up">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl my-6 font-bold text-blue-950 dark:text-white leading-[2.5rem] md:leading-[3.5rem]">
          ...
          <p className="text-xs sm:text-sm md:text-base font-medium text-gray-700 dark:text-gray-500">
            ...
            quas unde beatae voluptatibus, culpa, et est fuga, reiciendis
            officia adipisci voluptas eius quibusdam! Architecto nemo eos
            perspiciatis fugit tempore consequuntur consequatur vitae!
          </p>
          {/* buttons */}
